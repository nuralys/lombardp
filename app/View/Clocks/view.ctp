						...
						<div class="order">
							<div class="wr">
								...
								<h2 class="order_title">
	                                <span class="c_heading"><?=$data['Clock']['brand']?></span>
			...
			<div class="up_order">
				<div class="cr">
					<div class="or_row">
						<div class="wr">
						<ul class="ol_char">
							<li><span>Бренд:</span><?=$data['Clock']['brand']?></li>
									...
									<ul class="spec_ul">
										<li>
											...
											<div class="spec_value">
												<span><?=$data['Clock']['type']?></span>
											</div>
										</li>
										<li>
											<div class="spec_name">Материал корпуса:</div>
											<div class="spec_value">
												<span><?=$data['Clock']['housing_material']?></span>
											</div>
										</li>
										<li>
								...
								<div class="wr">
									<ul class="spec_ul">
										...
										<li>
											...
											<div class="spec_value">
												<span><?=$data['Clock']['equipment']?></span>
											</div>
										</li>
										<li>
											<div class="spec_name">Состояние</div>
											<div class="spec_value">
												<span><?=$data['Clock']['condition_clock']?></span>
											</div>
										</li>
									</ul>
								</div>
